...
section '.data' data writeable
    ...
    szText  db  "Hello NtDll!", 0
    szCap   db  "FASM Says", 0


section '.code' code readable executable

    LDR_LOAD_DLL = 0x0000000032855A46
    LDR_GET_PROC_ADDR = 0x0000000050E39822
...
main:
    ...
    invoke MessageBoxTimeoutA, 0, szText, szCap, 0x40, 0, 2000
